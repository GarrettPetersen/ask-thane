...
export const slashCommands: SlashCommand[] = [
  ...
  { name: "/webhook-create", usage: "/webhook-create <name> <https-url>", description: "Admin: create a webhook bot.", needsArgument: true, adminOnly: true },
  { name: "/webhook-disable", usage: "/webhook-disable <id-or-name>", description: "Admin: disable a webhook bot.", needsArgument: true, adminOnly: true },
  { name: "/webhook-channel-add", usage: "/webhook-channel-add <id-or-name> <channel>", description: "Admin: add a webhook bot to a channel.", needsArgument: true, adminOnly: true },
  { name: "/webhook-channel-remove", usage: "/webhook-channel-remove <id-or-name> <channel>", description: "Admin: remove a webhook bot from a channel.", needsArgument: true, adminOnly: true },
