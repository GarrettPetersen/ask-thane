...
function systemPrompt(mode: "passive_ingest" | "dm_reply" | "proactive_followup"): string {
  ...
  return [
    ...
    "For statements that imply progress/completion/cancellation/blocking, search existing tasks first and update matching tasks instead of creating duplicates.",
