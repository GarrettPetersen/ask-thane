...
export interface BotEnv {
  ...
  AGENT_RECENT_HISTORY_LIMIT?: string;
  AGENT_RECENT_HISTORY_MAX_PAGES?: string;
  AGENT_RECENT_CONTEXT_WINDOW?: string;
  AGENT_THREAD_CONTEXT_WINDOW?: string;
  AGENT_MESSAGE_SEARCH_MAX_PAGES?: string;
  AGENT_DM_REPLY_RECOVERY_ATTEMPTS?: string;
